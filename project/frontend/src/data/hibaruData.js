...
export const HIBARU_DATA = {
  ...
  news: [
    { date: '2026.04.20', title: '【テレビ放映情報】4月29日（祝）NHK BSプレミアム「美空ひばり不死鳥コンサート」放映', type: 'tv' },
    { date: '2026.04.15', title: '【イベント】5月29日（誕生日）記念館フィルムコンサート開催決定', type: 'event' },
    { date: '2026.04.10', title: '【テレビ放映情報】4月17日（金）テレビ朝日系「ザ・ベストテン名場面集」に美空ひばり出演映像', type: 'tv' },
    { date: '2026.03.28', title: '【グッズ】「川の流れのように」発売37周年記念 特別限定盤CD発売', type: 'goods' },
    { date: '2026.03.15', title: '【記念館】4月29日《春と恋・愛のフィルムコンサート》開催（要予約・3,000円）', type: 'event' },
  ],
  ...
  events: [
    { id: 1, title: 'みだれ髪ゆかりの地ツアー', type: 'tour', date: '2026.05.17（日）', place: '福島県いわき市 塩屋崎灯台', fee: '¥8,800（会員割引 ¥7,500）', capacity: '定員30名', partner: 'いわき市観光協会 協力' },
    { id: 2, title: '第18回 ひばりをうたうのど自慢大会', type: 'nodojiman', date: '2026.05.24（日）', place: '横浜市磯子公会堂', fee: '参加無料（観覧 ¥500）', capacity: '定員200名', partner: '横浜市磯子区 協力' },
    { id: 3, title: '横浜・野毛 銅像前ファン交流会', type: 'tour', date: '2026.05.29（誕生日）', place: '横浜市野毛 美空ひばり像前', fee: '無料', capacity: '自由参加', partner: '野毛商店街振興組合 協力' },
    { id: 4, title: '春のカラオケ大会 〜ひばりを歌う夕べ〜', type: 'karaoke', date: '2026.06.07（土）', place: '東京都内（会場調整中）', fee: '¥2,000（飲食別）', capacity: '定員50名', partner: '' },
    { id: 5, title: '不死鳥忌フォトコンテスト 2026', type: 'photo', date: '〆切:2026.06.15', place: 'オンライン＋表彰式:東京', fee: '参加無料', capacity: '一般公開', partner: '' },
  ],
