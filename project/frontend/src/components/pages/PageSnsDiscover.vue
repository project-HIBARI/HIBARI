          ...
          <ul v-else class="sns-discover__user-list">
            <li v-for="fan in songFans" :key="fan.account_id" class="sns-discover__user-row">
              <span class="sns-discover__user-main">
                <StoryAvatar
                  :account-id="fan.account_id"
                  :name="fan.name"
                  :avatar-path="fan.avatar_path"
                  :size="40"
                  @open-profile="openProfile(fan.account_id)"
                />
                <button type="button" class="sns-discover__user-meta" @click="openProfile(fan.account_id)">
